...
// Verificar que solo el administrador acceda
...
.card { background-color: #2c3e70; padding: 20px; border-radius: 12px; box-shadow: 0 8px 20px rgba(0,0,0,0.3); }
table { color: #ffffff; }
th, td { vertical-align: middle !important; }
.btn-approve { background-color: #4a6ea0; border: none; color: #fff; }
.btn-approve:hover { background-color: #36538b; }
.btn-reject { background-color: #a03a3a; border: none; color: #fff; }
.btn-reject:hover { background-color: #7b2b2b; }
</style>
</head>
<body>
<div class="container">
